...
import math
from datasets.frame_loader2 import FrameLoader, trainval_split
...
parser.add_argument('--model', metavar='MODEL', default='SDCNet2D', choices=model_names, help='model name')
        ...
        for i, batch in enumerate(tqdm(val_loader, total=num_batches)):
            ...
            for b in range(args.val_batch_size):
                ...
                if args.write_images:
                    ...
                    path = os.path.join( args.save_root, image_filename )
